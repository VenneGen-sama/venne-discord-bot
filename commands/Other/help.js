...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    .setDescription(`Type The Following Command For A Specific Command Information -\n**${Prefix}Help <Command Name>**\n\n**🔧 Config**\n${Config}\n\n**🧿 Other**\n${Other}\n\nUseful Links:\nSupport Server - [Click here](${Support || "https://discord.gg/GJzF72bFtD"})\nBot Link - [Invite me to your server!](https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=8)\n\nThank You So Much <3`)
